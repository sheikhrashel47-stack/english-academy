    ...
    <AppShell eyebrow="আজকের পরিকল্পনা" title="তোমার English study space">
      <div className="academy-dashboard">
        <section className="academy-dashboard-main">
          ...
          <section className="personal-study-ledger paper-card" aria-label="Personal growth workspace"><div><p className="card-kicker">Personal learning ledger</p><h2>Goal, XP, streak ও অর্জনের evidence</h2><p>তোমার বাস্তব study activity থেকে তৈরি local personal growth record দেখো।</p></div><Button variant="outline" onClick={() => setLocation("/growth")}>Growth খুলুন<ArrowRight size={16} /></Button></section>
