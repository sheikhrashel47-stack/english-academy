/**
 * Design reminder — “Emerald Study House”: practice is a focused, calm learning
 * session. Feedback records a useful review item without gamified route language.
 */
...
const difficultyOptions = [{ id: 1, label: "Easy", note: "শুরু করার জন্য" }, { id: 2, label: "Medium", note: "আরও একটু ভাবো" }, { id: 3, label: "Hard", note: "মনোযোগ দিয়ে চেষ্টা করো" }];
