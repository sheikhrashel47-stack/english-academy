 ...
 */
import { BookOpenCheck, ChartNoAxesCombined, CheckCircle2, Clock3, Sprout, Target } from "lucide-react";
...
export default function ProgressPage() {
  ...
  useEffect(() => { void Promise.all([learningUseCases.getRoadmap(), learningUseCases.getLearningSummary(), learningUseCases.getSkillMastery(), learningUseCases.getSkillRecommendations()]).then(([roadmap, nextSummary, mastery, nextRecommendations]) => { setItems(roadmap); setSummary(nextSummary); setSkillMastery(mastery); setRecommendations(nextRecommendations); }); }, []);
